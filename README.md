# MMM-Dresden-Abfahrtsmonitor
Public Transport of Dresden (DVB/VVO) Module for MagicMirror<sup>2</sup>
...
## Installation
 ...
 2. Configure your `~/MagicMirror/config/config.js`:
    ...
    ```
 3. Run command `npm install` in `~/MagicMirror/modules/MMM-Dresden-Abfahrtsmonitor` directory.

## Config Options
| **Option** | **Default** | **Description** |
| --- | --- | --- |
| `api_key` | REQUIRED | Get an API key for free access to the data of www.DVB.at [here](https://www.wien.gv.at/formularserver2/user/formular.aspx?pid=3b49a23de1ff43efbc45ae85faee31db&pn=B0718725a79fb40f4bb4b7e0d2d49f1d1). |
